...
<head>
	...
	<title>Uncle Bear's Power Tools - Product Details</title>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 col-sm-5 col-sm-offset-1 col-md-4 col-md-offset-2 well well-sm text-center">
				<img src="products/<?php echo $readrow['FLD_PRODUCT_ID'];?>.jpg" class="img-responsive" alt="products/nophoto.jpg">
			</div>
				...
				<div class="panel panel-default">
					...
					<table class="table">
						...
						<tr>
							...
							<td><?php echo $readrow["FLD_WATTAGE"];?></td>
						</tr>
					</table>
				</div>
			</div>
